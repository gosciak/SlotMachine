...
//  SlotMachine
//
//  Created by Doug Gosciak on 14/12/07.
...
class Factory {
    ...
    // Eric Arntz class notes solution
...
// }
    ...
    // snappedcoffee more flexible solution
    class func createSlots(numberOfSlots: Int, numberOfContainers: Int) -> [[Slot]] {
        var slots: [[Slot]] = []
    ...
    class func createSlots() -> [[Slot]] {
        ...
        return self.createSlots(kNumberOfSlots, numberOfContainers: kNumberOfContainers)
    }
